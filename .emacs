...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dired+ exec-path-from-shell go-complete company-go company solarized-theme plain-theme birds-of-paradise-plus-theme light-soap-theme ubuntu-theme monokai-theme go-mode go-autocomplete)))
